...
legend("topright", lty = c(1,1,1), col = c("black", "red", "blue"), legend = c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"), bty="n", cex = 0.3)
##upper-right plot :
with(energy, plot(datetime, Voltage, type="l", xlab ="datetime", ylab = "Voltage"))
##lower-left plot :
with(energy, plot(datetime, Global_reactive_power, type="l", xlab ="datetime", ylab = "Global_reactive_power"))
